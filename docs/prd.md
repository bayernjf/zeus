...
> 状态：**现行 v0.27（2026-09-25，编制可撤岗换 lead + 中文部门名可立 + 升级单条可读 + 记忆按 run 回放）**；v0.25（E4.8 阻塞归因纠偏，状态仍 🚧）；上一条 v0.24（2026-09-25，E1.5 有界并发队列 + E4.7 审计落盘可读 + E3.5 企业域收口 + 连接器/决策面接线 + 快照 0600）
