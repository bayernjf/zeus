...
> 状态：**现行 v0.28（2026-09-25，企业域三级租户隔离 + 双域授权与审计呈现（E3.6/E6.4 收口，P0 仅剩 E4.8 真机验收）**；v0.25（E4.8 阻塞归因纠偏，状态仍 🚧）；上一条 v0.24（2026-09-25，E1.5 有界并发队列 + E4.7 审计落盘可读 + E3.5 企业域收口 + 连接器/决策面接线 + 快照 0600）
