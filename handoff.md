...
* [docs/design-agentic-integration.md](docs/design-agentic-integration.md) — Agent 时代系统互联与确定性边界 v0.2：Agent 作编排层而非替代 REST 的两层架构、划边界四轴、确定性闸门、钉死/交给清单、MCP·A2A·Skill 插座、§6A AI 原生软件行业现状（五种主流实践+三条原则）、闸门软肋 ★
